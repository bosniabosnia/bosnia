...
<div class="header" >
    <div id="logo_image1"><!--img src=../images/odhea.jpg /--></div>
                <div >
						<div style="font-size:10px;font-family:arial;">Sistem Informasi<br></div>
						<div style="font-size:12px;font-family:arial;"><strong>Hidayah Farma</strong></div>
						<div style="font-size:8px;font-family:arial;">Jl. Raya Jati Kapur</div>
						<div style="font-size:7px;font-family:arial;">Telp : 0812 2356 1289 </div>
						</div><br>
	</div>
	</head>
	<?php
